...
| [`open-webui`](open-webui/) | `open-webui` | 0.11.0-2 | deferred | [Fresh Open WebUI 0.11.0 native-RAG envelope](https://github.com/nisavid/arch-pkgs/issues/68) | 2026-08-19 | Excluded; verify the immutable offline npm and Python closures, build and inspect the exact candidate without egress, then complete #68 integrated provider, restore, and rollback measurement before #69 policy. | no |
