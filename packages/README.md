...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [`ctranslate2`](ctranslate2/) | `ctranslate2`, `python-ctranslate2` | 4.8.2-1 | deferred | [CTranslate2 4.8.2](https://github.com/nisavid/arch-pkgs/issues/26#issuecomment-5783734367) | 2026-09-22 | Excluded; [G0-G2 candidate evidence](../docs/maintainers/evidence/speech-providers-4.8.2-1.2.1/) passed. Next gate: the integrated speech-to-text smoke under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90). | no |
...
| [`python-faster-whisper`](python-faster-whisper/) | `python-faster-whisper` | 1.2.1-1 | deferred | [Faster Whisper 1.2.1](https://github.com/nisavid/arch-pkgs/issues/26#issuecomment-5258698835) | 2026-09-22 | Excluded; [G0-G2 candidate evidence](../docs/maintainers/evidence/speech-providers-4.8.2-1.2.1/) passed. Next gate: the integrated speech-to-text smoke under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90). | no |
...
| [`qdrant`](qdrant/) | `qdrant` | 1.19.1-1 | deferred | [Qdrant 1.19.0 via 1.18.3, with Qdrant Web UI 0.2.16](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-25 | Excluded; G0-G3 accepted on the exact 1.19.1-1 artifacts, re-baselined from 1.19.0-1 ([1.19.1 G0-G3 evidence](../docs/maintainers/evidence/qdrant-1.19.1-1/)). Next gate: promotion together with Open WebUI under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
| [`qdrant-migration`](qdrant-migration/) | `qdrant-migration` | 1.18.3-1 | deferred | [Retained Qdrant 1.18.3 consecutive-minor migration artifact](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-25 | Excluded; G0-G3 accepted; the unchanged 1.18.3-1 archive is bound again by the [1.19.1 G0-G3 evidence](../docs/maintainers/evidence/qdrant-1.19.1-1/). Next gate: promotion together with Open WebUI under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
| [`qdrant-web-ui`](qdrant-web-ui/) | `qdrant-web-ui` | 0.2.18-1 | deferred | [Qdrant Web UI 0.2.16 in the Qdrant 1.19.0 service contract](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-25 | Excluded; G0-G3 accepted on the exact 0.2.18-1 artifact, re-baselined from 0.2.16-1 ([1.19.1 G0-G3 evidence](../docs/maintainers/evidence/qdrant-1.19.1-1/)). Next gate: promotion together with Open WebUI under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
