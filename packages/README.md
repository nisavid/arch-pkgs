...
| [`qdrant`](qdrant/) | `qdrant` | 1.19.0-1 | deferred | [Qdrant 1.19.0 via 1.18.3, with Qdrant Web UI 0.2.16](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-22 | Excluded; G0-G3 accepted. Promotion rides the integrated Open WebUI household acceptance under [Chart the Open WebUI 0.11 household runtime](https://github.com/nisavid/arch-pkgs/issues/48); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
| [`qdrant-migration`](qdrant-migration/) | `qdrant-migration` | 1.18.3-1 | deferred | [Retained Qdrant 1.18.3 consecutive-minor migration artifact](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-22 | Excluded; G0-G3 accepted. Promotion rides the integrated Open WebUI household acceptance under [Chart the Open WebUI 0.11 household runtime](https://github.com/nisavid/arch-pkgs/issues/48); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
| [`qdrant-web-ui`](qdrant-web-ui/) | `qdrant-web-ui` | 0.2.16-1 | deferred | [Qdrant Web UI 0.2.16 in the Qdrant 1.19.0 service contract](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-22 | Excluded; G0-G3 accepted. Promotion rides the integrated Open WebUI household acceptance under [Chart the Open WebUI 0.11 household runtime](https://github.com/nisavid/arch-pkgs/issues/48); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
