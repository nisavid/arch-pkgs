...
| [`qdrant`](qdrant/) | `qdrant` | 1.19.1-1 | deferred | [Qdrant 1.19.0 via 1.18.3, with Qdrant Web UI 0.2.16](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-25 | Excluded; re-baselined from the G0-G3-accepted 1.19.0-1 to the 1.19.1 patch release; G0-G3 must pass again on the exact 1.19.1-1 artifacts. Next gate: promotion together with Open WebUI under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
...
| [`qdrant-web-ui`](qdrant-web-ui/) | `qdrant-web-ui` | 0.2.18-1 | deferred | [Qdrant Web UI 0.2.16 in the Qdrant 1.19.0 service contract](https://github.com/nisavid/arch-pkgs/issues/28#issuecomment-5259788912) | 2026-09-25 | Excluded; re-baselined from the G0-G3-accepted 0.2.16-1 to 0.2.18; G0-G3 must pass again on the exact 0.2.18-1 artifact. Next gate: promotion together with Open WebUI under [Promote or defer the Open WebUI household stack](https://github.com/nisavid/arch-pkgs/issues/90); deploy via [Deploy the accepted Qdrant service](https://github.com/nisavid/arch-pkgs/issues/58). | no |
